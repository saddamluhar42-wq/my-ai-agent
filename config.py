...
def get_config_status():
    return {"gemini":is_gemini_configured(),"openrouter":is_openrouter_configured(),"groq":is_groq_configured(),"cerebras":is_cerebras_configured(),"mistral":is_mistral_configured(),"anthropic":is_anthropic_configured(),"deepseek":is_deepseek_configured(),"kimi":is_kimi_configured(),"openai":is_openai_configured(),"xai":is_xai_configured(),"you":is_you_configured(),"huggingface":is_hf_configured(),"nvidia":is_nvidia_configured(),"google_video":is_google_video_configured(),"runway_video":is_runway_configured(),"luma_video":is_luma_configured(),"kling_video":is_kling_configured(),"replicate_video":is_replicate_configured(),"tavily":is_tavily_configured(),"database":is_database_configured(),"telegram":is_telegram_configured(),"video_default_provider":VIDEO_DEFAULT_PROVIDER,"configured_video_providers":get_configured_video_providers()}
