...
def render_sidebar() -> None:
    with st.sidebar:
        ...
        if st.button("＋ New Chat", use_container_width=True, type="primary"):
            st.session_state["messages"]=[]; st.session_state["recent_context"]=[]; st.session_state["file_context"]=""; st.session_state["uploaded_names"]=[]; st.rerun()
...
def main() -> None:
    initialize_state(); boot_video_system(); render_sidebar(); render_header(); render_messages(); prompt=st.chat_input("Message My AI Agent...")
